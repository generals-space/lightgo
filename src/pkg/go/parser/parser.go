...
func (p *parser) init(fset *token.FileSet, filename string, src []byte, mode Mode) {
	...
	p.scanner.Init(p.file, src, errorHandler, m)
...
//
// A line comment is a comment group that follows a non-comment token
// on the same line,
// and that has no tokens after it on the line where it ends.
//
