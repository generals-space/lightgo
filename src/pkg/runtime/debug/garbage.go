...
// 	@implementBy: src/pkg/runtime/mgc0.c -> runtime∕debug·readGCStats()
func readGCStats(*[]time.Duration)
func enableGC(bool) bool
// 	@implementBy: src/pkg/runtime/mgc0.c -> runtime∕debug·setGCPercent()
func setGCPercent(int) int
func freeOSMemory()
// 	@implementBy: src/pkg/runtime/stack.c -> runtime∕debug·setMaxStack()
func setMaxStack(int) int
// 	@implementBy: src/pkg/runtime/proc.c -> runtime∕debug·setMaxThreads()
...
// (Even if this is not called, the runtime gradually
